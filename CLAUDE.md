...
- All GitHub writes flow through `internal/replay.Push` over the Git Data API (ADR 0006); there is no GraphQL path.
...
Read `docs/decisions/` before architectural changes. 0001 commit model, 0002 refusal policy and measured ceiling, 0003 local sync, 0004 language and phasing, 0005 repository allow-list, 0006 Git Data transport.
